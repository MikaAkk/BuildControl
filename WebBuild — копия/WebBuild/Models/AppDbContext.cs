...
public class AppDbContext : DbContext
{
    ...
    public DbSet<EmployeeObjectAssignment> EmployeeObjectAssignments => Set<EmployeeObjectAssignment>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ContractTemplate>(e => e.Property(x => x.Id).HasColumnName("id"));
        modelBuilder.Entity<Contract>(e => e.Property(x => x.Id).HasColumnName("id"));
        modelBuilder.Entity<ContractStatus>(e => e.Property(x => x.Id).HasColumnName("id"));
        modelBuilder.Entity<EmployeeObjectAssignment>(e => e.Property(x => x.Id).HasColumnName("id"));
        ...
        modelBuilder.Entity<EmployeeObjectAssignment>(entity =>
        {
            // Связь: кто назначен
